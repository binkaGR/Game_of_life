...
volue_ex=0
while pov<100000:
    tread1=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 0, 10))
    tread3=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 10, 20))
    tread4=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 20, 30))
    tread5=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 30, 40))
    tread6=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 40, 50))
    tread7=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 50, 60))
    tread1.start()
    tread3.start()
    tread4.start()
    tread5.start()
    ...
    pov+=1
    tread2=threading.Thread(target=write_resulr, args=(arr_1, arr_2, 60 ))
    tread2.start()
