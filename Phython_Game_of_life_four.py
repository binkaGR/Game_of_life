...
volue_ex=0
while pov<100000:
    tread1=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 0, 15))
    tread3=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 15, 30))
    tread4=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 30, 45))
    tread5=threading.Thread(target=game_of_live, args=(arr_1, arr_2, row , 45, 60))
    tread1.start()
    tread3.start()
    tread4.start()
    tread5.start()
